...
def test_validation_alias_target_missing(monkeypatch):
    monkeypatch.setattr("src.graph_inventory.generate.load_aliases", lambda: {"alias_key": "nonexistent"})
    ...
    monkeypatch.setattr("src.graph_inventory.generate.load_skill_graphs", lambda: ({}, {}))
    
    with pytest.raises(ValueError) as excinfo:
        generate_inventories_payloads()
    assert "Alias target 'nonexistent' for alias 'alias_key' does not exist" in str(excinfo.value)
...
def test_validation_context_alias_target_missing(monkeypatch):
    ...
    monkeypatch.setattr("src.graph_inventory.generate.load_context_aliases", lambda: {"alias": [{"target": "nonexistent"}]})
    monkeypatch.setattr("src.graph_inventory.generate.load_domain_mappings", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_skill_graphs", lambda: ({}, {}))
    
    with pytest.raises(ValueError) as excinfo:
        generate_inventories_payloads()
    assert "Context alias target 'nonexistent' for context alias 'alias' does not exist" in str(excinfo.value)

def test_validation_context_alias_missing_target_key(monkeypatch):
    monkeypatch.setattr("src.graph_inventory.generate.load_aliases", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_context_aliases", lambda: {"alias": [{"default": True}]})
    monkeypatch.setattr("src.graph_inventory.generate.load_domain_mappings", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_skill_graphs", lambda: ({}, {}))
...
def test_validation_domain_mapping_key_missing(monkeypatch):
    monkeypatch.setattr("src.graph_inventory.generate.load_aliases", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_context_aliases", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_domain_mappings", lambda: {"nonexistent": "Frontend Development"})
    monkeypatch.setattr("src.graph_inventory.generate.load_skill_graphs", lambda: ({}, {}))
    
    with pytest.raises(ValueError) as excinfo:
        generate_inventories_payloads()
    assert "Domain mapping node ID 'nonexistent' does not exist in canonical tags" in str(excinfo.value)

def test_validation_prereq_target_missing(monkeypatch):
    monkeypatch.setattr("src.graph_inventory.generate.load_aliases", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_context_aliases", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_domain_mappings", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_skill_graphs", lambda: ({"node_a": ["missing_node"]}, {"node_a": "file.yaml"}))
    
    with pytest.raises(ValueError) as excinfo:
        generate_inventories_payloads()
    assert "Node 'node_a' has missing/unknown prerequisite target 'missing_node'" in str(excinfo.value)

def test_validation_difficulty_invalid_type(monkeypatch):
    monkeypatch.setattr("src.graph_inventory.generate.load_aliases", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_context_aliases", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_domain_mappings", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_skill_graphs", lambda: ({"node_a": {"difficulty": 123}}, {"node_a": "file.yaml"}))
...
def test_validation_estimated_hours_invalid_type(monkeypatch):
    ...
    monkeypatch.setattr("src.graph_inventory.generate.load_context_aliases", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_domain_mappings", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_skill_graphs", lambda: ({"node_a": {"estimated_hours": "ten"}}, {"node_a": "file.yaml"}))
...
def test_validation_estimated_hours_boolean(monkeypatch):
    ...
    monkeypatch.setattr("src.graph_inventory.generate.load_context_aliases", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_domain_mappings", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_skill_graphs", lambda: ({"node_a": {"estimated_hours": True}}, {"node_a": "file.yaml"}))
...
def test_validation_prereqs_not_list(monkeypatch):
    ...
    monkeypatch.setattr("src.graph_inventory.generate.load_context_aliases", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_domain_mappings", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_skill_graphs", lambda: ({"node_a": {"prerequisites": "not-a-list"}}, {"node_a": "file.yaml"}))
...
def test_validation_prereq_not_string(monkeypatch):
    ...
    monkeypatch.setattr("src.graph_inventory.generate.load_context_aliases", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_domain_mappings", lambda: {})
    monkeypatch.setattr("src.graph_inventory.generate.load_skill_graphs", lambda: ({"node_a": [123]}, {"node_a": "file.yaml"}))
...
def test_cli_script_check_success():
    res = subprocess.run([sys.executable, "scripts/generate_skill_inventory.py", "--check"], capture_output=True, text=True)
